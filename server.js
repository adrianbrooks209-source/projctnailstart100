...
const orderSchema = new mongoose.Schema({
    type: { type: String, required: true }, // 'order' or 'glam'
    name: { type: String, required: true },
    dateTime: { type: Date, required: true },
    orderType: String, // 'Pick Up' or 'Delivery'
    appointmentType: String, // 'Appointment' or 'Home Appointment'
    items: [String],
    services: [String],
...
const announcementSchema = new mongoose.Schema({
    from: { type: String, required: true }, // 'Owner' or 'Member Team'
